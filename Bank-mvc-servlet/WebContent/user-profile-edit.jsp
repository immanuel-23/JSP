  ...
  <div class="container-fluid">
   <a class="navbar-brand" href="UserDashboardController?command=displayDashboard">User Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="UserDashboardController?command=Editprofile">${user.userName}</a>
        </li>
        <li class="nav-item">
...
${user.userName} Profile</h1>
   ...
   <form action="UserDashboardController" > 
          ...
          <div>
                ...
                <br>
                <input type="text" name="id" class="form-control" value="${user.userId}" disabled="disabled">
            </div>
            ...
            <div>
                ...
                <br>
                <input type="text" name="password" class="form-control" value="${user.userPass}">
            </div>
            <div>
                <label for="balance">Update Balance : </label>
                <br>
                <input type="number" name="balance" class="form-control" value="${user.balance}" disabled="disabled" >
            </div>
            <div>
